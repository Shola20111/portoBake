  ...
  return (
    <header className="flex justify-between items-center w-[100%] h-[100px] mx-auto fixed z-50 px-[5%] bg-[#fff]">
      ...
      <div className="w-[25%]lg:w-[70%] flex justify-end items-center gap-5 pr-5 ">
        <ul className="hidden lg:flex gap-[30px]  items-center tracking-[3] max-text-[20px] text-[#3d4246]" style={{fontFamily:'Montserrat, HelveticaNeue, Helvetica Neue, sans-serif'}}>
          ...
          <button onClick={()=>handleShowNav()} className='max-w-12 max-h-12 block lg:hidden'>
        ...
        <div className="w-7">
          <svg aria-hidden="true" focusable="false" role="presentation" className="icon icon-cart max-w-7 max-h-7" viewBox="0 0 37 40"><path d="M36.5 34.8L33.3 8h-5.9C26.7 3.9 23 .8 18.5.8S10.3 3.9 9.6 8H3.7L.5 34.8c-.2 1.5.4 2.4.9 3 .5.5 1.4 1.2 3.1 1.2h28c1.3 0 2.4-.4 3.1-1.3.7-.7 1-1.8.9-2.9zm-18-30c2.2 0 4.1 1.4 4.7 3.2h-9.5c.7-1.9 2.6-3.2 4.8-3.2zM4.5 35l2.8-23h2.2v3c0 1.1.9 2 2 2s2-.9 2-2v-3h10v3c0 1.1.9 2 2 2s2-.9 2-2v-3h2.2l2.8 23h-28z"></path></svg>
        </div>
